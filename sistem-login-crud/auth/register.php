    ...
    if (!verify_csrf_token($_POST['csrf_token'] ?? '')) {
        ...
        if (empty($errors)) {
            try {
                ...
                $stmt = $conn->prepare("INSERT INTO users (username, password, nama_lengkap, email, role, created_at) 
                                      VALUES (:username, :password, :nama_lengkap, :email, :role, NOW())");
    ...
    <div class="container">
        ...
        <form action="register.php" method="post">
            ...
            <div>
                ...
                <small>Minimal 8 karakter, harus mengandung huruf besar, huruf kecil, dan angka</small>
            </div>
